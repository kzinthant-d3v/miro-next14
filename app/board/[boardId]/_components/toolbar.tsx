  ...
  return (
    <div className="absolute top-[350px] -translate-y-[50%] left-2 flex flex-col gap-y-4">
      <div className="bg-white rounded-md p-1.5 flex gap-y-1 flex-col items-center shadow-md">
        ...
        <ToolButton label="Retangle" icon={Square} onClick={
...
export function ToolbarSkeleton() {
  return <div className="absolute top-[400px] -translate-y-[50%] left-2 flex flex-col gap-y-4 bg-white h-[360px] w-[52px] shadow-md rounded-md" />
}
