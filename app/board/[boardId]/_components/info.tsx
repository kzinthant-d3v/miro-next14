...
export const Info = ({ boardId }: InfoProps) => {
  ...
  return (
    <div className="absolute top-2 left-2 rounded-md h-12 flex items-center shadow-md">
      <Hint label="Go to board" sideOffset={10}>
        <Button asChild variant="board" className="px-5">
          <Link href="/">
            <Image
              src="/logo.png"
              alt="logo"
      ...
      <TabSeperator />
      <Actions id={data._id} title={data.title} side="bottom" sideOffeset={10}>
        <div>
